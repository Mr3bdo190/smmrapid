...
export const translations: Dict = {
  ...
  'nav.admin.withdrawals': { en: 'Withdrawals', ar: 'السحوبات' },
  ...
  'admin.withdrawals.all': { en: 'All Statuses', ar: 'جميع الحالات' },
  'admin.withdrawals.noRequests': { en: 'No withdrawal requests found.', ar: 'لا توجد طلبات سحب.' },
  'admin.withdrawals.approve': { en: 'Approve', ar: 'موافقة' },
  'admin.withdrawals.reject': { en: 'Reject', ar: 'رفض' },
  'admin.withdrawals.approveConfirm': { en: 'Approve this affiliate withdrawal?', ar: 'الموافقة على سحب الإحالة؟' },
  'admin.withdrawals.rejectConfirm': { en: 'Reject this affiliate withdrawal?', ar: 'رفض سحب الإحالة؟' },
  'admin.withdrawals.approvedSuccess': { en: 'Withdrawal approved successfully.', ar: 'تمت الموافقة على السحب بنجاح.' },
  'admin.withdrawals.rejectedSuccess': { en: 'Withdrawal rejected.', ar: 'تم رفض السحب.' },
  'admin.withdrawals.adminNote': { en: 'Admin Note', ar: 'ملاحظة الإدارة' },
  'admin.withdrawals.method': { en: 'Method', ar: 'الطريقة' },
  'admin.withdrawals.destination': { en: 'Destination', ar: 'الوجهة' },
  'admin.withdrawals.user': { en: 'User', ar: 'المستخدم' },
  'admin.withdrawals.created': { en: 'Created', ar: 'تاريخ الإنشاء' },
  'admin.withdrawals.resolved': { en: 'Resolved', ar: 'تاريخ الحل' },
  'admin.withdrawals.amount': { en: 'Amount', ar: 'المبلغ' },
  'admin.withdrawals.status': { en: 'Status', ar: 'الحالة' },
  'client.withdraw.title': { en: 'Withdraw Funds', ar: 'سحب الأموال' },
  'client.withdraw.balance': { en: 'Available Balance', ar: 'الرصيد المتاح' },
  'client.withdraw.amount': { en: 'Amount', ar: 'المبلغ' },
  'client.withdraw.method': { en: 'Method', ar: 'طريقة السحب' },
  'client.withdraw.destination': { en: 'Destination', ar: 'الوجهة' },
  'client.withdraw.destinationPlaceholder': { en: 'e.g. phone number, wallet address, card number', ar: 'مثال: رقم الهاتف، محفظة، رقم البطاقة' },
  'client.withdraw.estimated': { en: 'Estimated to receive', ar: 'المبلغ المتوقع' },
  'client.withdraw.submit': { en: 'Submit Withdrawal Request', ar: 'إرسال طلب سحب' },
  'client.withdraw.minAmount': { en: 'Minimum withdrawal amount is {min}.', ar: 'الحد الأدنى للسحب هو {min}.' },
  'client.withdraw.invalidAmount': { en: 'Please enter a valid amount.', ar: 'الرجاء إدخال مبلغ صحيح.' },
  'client.withdraw.insufficientBalance': { en: 'Insufficient balance for this withdrawal.', ar: 'رصيد غير كافٍ للسحب.' },
  'client.withdraw.success': { en: 'Withdrawal request submitted successfully!', ar: 'تم إرسال طلب السحب بنجاح!' },
  'client.withdraw.error': { en: 'Withdrawal request failed. Please try again.', ar: 'فشل إرسال طلب السحب. حاول مرة أخرى.' },
  'client.withdraw.history': { en: 'Withdrawal History', ar: 'سجل السحوبات' },
  'client.withdraw.noHistory': { en: 'No withdrawals yet.', ar: 'لا توجد سحوبات بعد.' },
  'client.withdraw.bankTransfer': { en: 'Bank Transfer', ar: 'تحويل بنكي' },
  'client.withdraw.eWallet': { en: 'Electronic Wallet', ar: 'محفظة إلكترونية' },
  'client.withdraw.crypto': { en: 'Cryptocurrency', ar: 'عملة رقمية' },
  'client.withdraw.vodafoneCash': { en: 'Vodafone Cash', ar: 'فودافون كاش' },
  'client.withdraw.orangeCash': { en: 'Orange Cash', ar: 'أورنج كاش' },
  'client.withdraw.etisalatCash': { en: 'Etisalat Cash', ar: 'إتصالات كاش' },
  ...
  'notifications.unreadCount': { en: 'Unread notifications', ar: 'إشعارات غير مقروءة' },
  'notifications.allRead': { en: 'All caught up', ar: 'كل الإشعارات مقروءة' },
  'notifications.close': { en: 'Close notifications', ar: 'إغلاق الإشعارات' },
  'notifications.now': { en: 'Just now', ar: 'الآن' },
  'notifications.minutesAgo': { en: 'min ago', ar: 'دقيقة مضت' },
  'notifications.hoursAgo': { en: 'h ago', ar: 'ساعة مضت' },
  'notifications.daysAgo': { en: 'd ago', ar: 'يوم مضت' },
  'notifications.showing': { en: 'Showing the latest', ar: 'بيتم عرض الأحدث' },
  'addFunds.methods': { en: 'Available payment methods', ar: 'وسائل الدفع المتاحة' },
  'addFunds.methodWalletDesc': { en: 'Send an electronic-wallet transfer and confirm it from your phone.', ar: 'حوّل من محفظتك الإلكترونية وأكّد العملية من تليفونك.' },
  'addFunds.methodCryptoDesc': { en: 'Pay in USD with the crypto gateway and get the exact amount.', ar: 'ادفع بالدولار عبر بوابة العملات الرقمية بالمبلغ بالظبط.' },
  'addFunds.selectWallet': { en: 'Choose the wallet you will pay from', ar: 'اختر المحفظة التي ستدفع منها' },
  'addFunds.instructions': { en: 'Payment instructions', ar: 'تعليمات الدفع' },
  'addFunds.payFrom': { en: 'Paying from', ar: 'الدفع من' },
  'addFunds.walletNumber': { en: 'Your wallet number', ar: 'رقم محفظتك' },
  'addFunds.walletNumberHint': { en: '11 digits, starting with 01', ar: '11 رقم ويبدأ بـ 01' },
  'addFunds.payWindow': { en: 'Payment window', ar: 'مدة الدفع المتاحة' },
  'addFunds.timeLeft': { en: 'Time left to pay', ar: 'الوقت المتبقي للدفع' },
  'addFunds.checkNow': { en: 'Check payment status', ar: 'تحديث حالة الدفع' },
  'addFunds.checking': { en: 'Checking the payment…', ar: 'بنتحقق من الدفع…' },
  'addFunds.autoCheck': { en: 'The status is checked automatically every 10 seconds.', ar: 'بيتم التحقق من حالة الدفع تلقائياً كل 10 ثواني.' },
  'addFunds.lastChecked': { en: 'Last checked', ar: 'آخر تحقق' },
  'addFunds.statusPending': { en: 'Waiting for your payment', ar: 'في انتظار دفعتك' },
  'addFunds.statusPaid': { en: 'Payment received', ar: 'تم استلام الدفع' },
  'addFunds.statusFailed': { en: 'Payment failed', ar: 'فشلت العملية' },
  'addFunds.paidTitle': { en: 'Payment received and balance added', ar: 'تم استلام الدفع وإضافة الرصيد' },
  'addFunds.paidBody': { en: 'Your wallet has been topped up. You can see the movement in your transactions.', ar: 'تم شحن محفظتك. تقدر تشوف الحركة في سجل المعاملات.' },
  'addFunds.openTransactions': { en: 'View wallet transactions', ar: 'عرض حركات المحفظة' },
  'addFunds.notPaidTitle': { en: 'We have not received this payment yet', ar: 'لم نستلم هذه الدفعة حتى الآن' },
  'addFunds.notPaidBody': { en: 'Finish the payment from your wallet app, then press check status. If you already paid, confirmation can take a moment.', ar: 'أكمل الدفع من تطبيق المحفظة ثم اضغط تحديث حالة الدفع. ولو دفعت بالفعل، التأكيد ممكن يتأخر لحظة.' },
  'addFunds.windowExpired': { en: 'The payment window ended without a confirmed payment.', ar: 'انتهت مدة الدفع بدون تأكيد العملية.' },
  'addFunds.retry': { en: 'Create a new payment request', ar: 'إنشاء طلب دفع جديد' },
  'addFunds.newRequest': { en: 'New payment request', ar: 'طلب دفع جديد' },
  'addFunds.availableNow': { en: 'Available now', ar: 'متاح الآن' },
  'addFunds.notConfigured': { en: 'Not available right now', ar: 'غير متاح حالياً' },
  'addFunds.amountHint': { en: 'Amount is entered in EGP and converted to USD automatically.', ar: 'المبلغ بالجنيه ويُحوَّل للدولار تلقائياً.' },
  'addFunds.paymentSummary': { en: 'Payment summary', ar: 'ملخص الدفع' },
  ...
  // Financial limits
  'settings.minDeposit': { en: 'Minimum Deposit Amount (USD)', ar: 'أقل مبلغ إيداع (دولار)' },
  'settings.minDepositDesc': { en: 'The minimum amount a user can deposit via any payment method.', ar: 'أقل مبلغ يستطيع المستخدم إيداعه عبر أي طريقة دفع.' },
  'settings.minWithdrawal': { en: 'Minimum Withdrawal Amount (USD)', ar: 'أقل مبلغ سحب (دولار)' },
  'settings.minWithdrawalDesc': { en: 'The minimum amount required to withdraw affiliate earnings.', ar: 'أقل مبلغ مطلوب لسحب أرباح الإحالة.' },
  ...
  'admin.settings.addFundsDesc': { en: 'Edit the instructions customers see on the Add Funds page. Keep both languages clear and actionable.', ar: 'عدّل التعليمات التي يراها العملاء في صفحة إضافة رصيد. حافظ على وضوح اللغتين.' },
  'admin.settings.walletIntroAr': { en: 'Wallet introduction — العربية', ar: 'مقدمة المحفظة — بالعربية' },
  'admin.settings.walletIntroEn': { en: 'Wallet introduction — English', ar: 'مقدمة المحفظة — بالإنجليزية' },
  'admin.settings.walletVerificationAr': { en: 'Automatic verification — العربية', ar: 'التحقق التلقائي — بالعربية' },
  'admin.settings.walletVerificationEn': { en: 'Automatic verification — English', ar: 'التحقق التلقائي — بالإنجليزية' },
  'admin.settings.baseUrl': { en: 'Base URL', ar: 'الرابط الأساسي' },
  'admin.settings.merchantWallet': { en: 'Merchant Wallet Number', ar: 'رقم محفظة التاجر' },
  'admin.settings.minEgp': { en: 'Minimum EGP', ar: 'أقل مبلغ (جنيه)' },
  'admin.settings.maxEgp': { en: 'Maximum EGP', ar: 'أقصى مبلغ (جنيه)' },
  'admin.settings.sha7nawyGate': { en: 'Electronic Wallet — Sha7nawy Gate', ar: 'المحفظة الإلكترونية — بوابة Sha7nawy' },
  'admin.settings.sha7nawyDesc': { en: 'Vodafone Cash / Orange Cash / Etisalat Cash. Secret Key stays on the server and is never sent to the client.', ar: 'فودافون كاش / أورنج كاش / إتصالات كاش. المفتاح السري يبقى على الخادم ولا يُرسل للعميل.' },
  'admin.settings.sha7nawyPublic': { en: 'Public Key', ar: 'المفتاح العام' },
  'admin.settings.sha7nawySecret': { en: 'Secret Key', ar: 'المفتاح السري' },
  'admin.settings.webhook': { en: 'Webhook', ar: 'الويب هوك' },
  'admin.settings.webhookDesc': { en: 'Created automatically from PUBLIC_APP_URL.', ar: 'يتم إنشاؤه تلقائياً من PUBLIC_APP_URL.' },
  'admin.settings.security': { en: 'Additional security', ar: 'أمان إضافي' },
  'admin.settings.securityDesc': { en: 'The system does not trust the webhook alone; on receipt it re-queries the transaction using the Secret Key and verifies amount and status before crediting the wallet.', ar: 'النظام لا يثق بالويب هوك وحده؛ عند وروده يعيد استعلام المعاملة باستخدام المفتاح السري ويتحقق من المبلغ والحالة قبل إضافة الرصيد.' },
  'admin.settings.exchange': { en: 'Exchange Rate', ar: 'سعر الصرف' },
  'admin.settings.exchangeRate': { en: '(EGP per 1 USD)', ar: '(جنيه لكل 1 دولار)' },
  'admin.settings.exchangeRateDesc': { en: 'The USD internal wallet. Amounts paid in EGP are converted to USD at this rate before the balance is added.', ar: 'المحفظة الداخلية بالدولار. المبالغ المدفوعة بالجنيه تُحوّل للدولار بهذا السعر قبل إضافة الرصيد.' },
  'admin.settings.affiliate': { en: 'Affiliate System', ar: 'نظام الإحالة' },
  'admin.settings.commission': { en: 'Commission Percentage (%)', ar: 'نسبة العمولة (%)' },
  'admin.settings.commissionDesc': { en: 'Percentage earned by affiliates on approved payments.', ar: 'النسبة التي يكسبها المحالون على المدفوعات المعتمدة.' },
  'admin.settings.profitMargin': { en: 'Default provider profit margin (%)', ar: 'هامش الربح الافتراضي للمزود (%)' },
  'admin.settings.profitMarginDesc': { en: 'Used when creating a new provider. Existing providers keep their own margin until you edit them.', ar: 'يُستخدم عند إنشاء مزود جديد. المزودون الموجودون يحتفظون بهوامشهم حتى تقوم بتعديلها.' },
  'admin.settings.siteName': { en: 'Site Name', ar: 'اسم الموقع' },
  'admin.settings.currencySymbol': { en: 'Currency Symbol', ar: 'رمز العملة' },
  'admin.settings.supportEmail': { en: 'Support Email', ar: 'بريد الدعم' },
  'admin.settings.siteLogo': { en: 'Site Logo URL', ar: 'رابط شعار الموقع' },
  'admin.settings.heleketConnection': { en: 'Heleket Connection', ar: 'اتصال Heleket' },
  'admin.settings.heleketTest': { en: 'Test the currently configured crypto payment gateway.', ar: 'اختبر بوابة العملات الرقمية المُهيأة حالياً.' },
  'admin.settings.testHeleket': { en: 'Test Heleket Connection', ar: 'اختبار اتصال Heleket' },
  'admin.settings.connected': { en: 'Connected. Merchant', ar: 'متصل. التاجر' },
  'admin.settings.connectionFailed': { en: 'Connection failed.', ar: 'فشل الاتصال.' },
  'admin.settings.save': { en: 'Save Settings', ar: 'حفظ الإعدادات' },

  // Admin reports
  'admin.settings.systemReports': { en: 'System Reports', ar: 'تقارير النظام' },
  'admin.settings.reportsSubtitle': { en: 'Search failures and mark handled incidents as resolved.', ar: 'ابحث عن الأخطاء وحدد الحوادث المنتهاة كمنجزة.' },

  // Error handling
  'errors.minAmount': { en: 'The amount entered is below the minimum deposit of {min}.', ar: 'المبلغ الذي أدخلته أقل من الحد الأدنى للإيداع وهو {min} دولار.' },
  'errors.minWithdrawal': { en: 'The amount entered is below the minimum withdrawal of {min}.', ar: 'المبلغ الذي أدخلته أقل من الحد الأدنى للسحب هو {min} دولار.' },
  'errors.internal': { en: 'Something went wrong. Please try again later.', ar: 'حدث خطأ. من فضلك حاول مرة أخرى لاحقاً.' },

  // System logs (integrated into Reports page)
  'settings.systemLogs': { en: 'System Logs', ar: 'سجلات النظام' },
  'settings.systemLogsSubtitle': { en: 'Server and database errors logged by the system', ar: 'أخطاء الخادم وقاعدة البيانات التي سجلها النظام' },
  'settings.logLevel': { en: 'Level', ar: 'المستوى' },
  'settings.logMessage': { en: 'Message', ar: 'الرسالة' },
  'settings.logDetails': { en: 'Details', ar: 'التفاصيل' },
  'settings.logTime': { en: 'Time', ar: 'الوقت' },
  'settings.clearOldLogs': { en: 'Clear logs older than 30 days', ar: 'مسح السجلات الأقدم من 30 يوماً' },
  'settings.clearing': { en: 'Clearing...', ar: 'جارٍ المسح...' },
  'settings.clearSuccess': { en: 'Old logs cleared', ar: 'تم مسح السجلات القديمة' },
  'settings.filterByLevel': { en: 'Filter by level', ar: 'تصفية حسب المستوى' },
  'settings.allLevels': { en: 'All levels', ar: 'كل المستويات' },
  'settings.loadingLogs': { en: 'Loading logs...', ar: 'جاري تحميل السجلات...' },
  ...
  'affiliates.withdraw': { en: 'Affiliate Withdrawals', ar: 'سحوبات الإحالة' },
  'affiliates.withdrawDesc': { en: 'Request a payout from your earned commissions. Requests are reviewed by admin.', ar: 'اطلب سحباً من عمولاتك المكتسبة. الطلبات تُمراجع من قبل الإدارة.' },
  'affiliates.withdrawAmount': { en: 'Amount USD', ar: 'المبلغ (دولار)' },
  'affiliates.withdrawMethod': { en: 'Payout method', ar: 'طريقة الدفع' },
  'affiliates.withdrawDestination': { en: 'Destination / account', ar: 'الوجهة / الحساب' },
  'affiliates.withdrawRequest': { en: 'Request withdrawal', ar: 'طلب سحب' },
  'affiliates.withdrawalRequested': { en: 'Withdrawal requested', ar: 'تم طلب السحب' },
  ...
  'affiliates.availableBalance': { en: 'Available Affiliate Balance', ar: 'الرصيد المتاح من الأرباح التابعة' },
  'affiliates.availableBalanceHint': { en: 'This amount is available for withdrawal to your preferred method.', ar: 'هذا المبلغ متاح للسحب عبر الطريقة المفضلة لك.' },
  'affiliates.totalEarnings': { en: 'Total Earnings', ar: 'إجمالي الأرباح' },
  'affiliates.totalPaidOut': { en: 'Total Paid Out', ar: 'إجمالي المدفوعات' },
  'affiliates.noWithdrawals': { en: 'No withdrawal requests yet.', ar: 'لا توجد طلبات سحب بعد.' },
  'admin.withdrawals.subtitle': { en: 'Manage affiliate commission withdrawal requests. These are strictly for referral/affiliate earnings.', ar: 'إدارة طلبات سحب عمولات الإحالة. هذه السحوبات مخصصة للأرباح التابعة فقط.' },
  'admin.withdrawals.approvePrompt': { en: 'Approve this affiliate withdrawal? Add an admin note (optional):', ar: 'موافقة على سحب إحالة؟ أضف ملاحظة إدارية (اختياري):' },
  'admin.withdrawals.rejectPrompt': { en: 'Reject this affiliate withdrawal? Add an admin note (optional):', ar: 'رفض هذا السحب؟ أضف ملاحظة إدارية (اختياري):' },
  'admin.withdrawals.resolvedSuccess': { en: 'Withdrawal updated successfully', ar: 'تم تحديث السحب بنجاح' },
};
...
const uiPhrasePairs: Array<[string, string]> = [
  ...
  ['Order Control Center','مركز التحكم في الطلبات'],['Order History','سجل الطلبات'],['Transactions & Payments','المعاملات والمدفوعات'],['Payment Methods Settings','إعدادات وسائل الدفع'],['Heleket Connection','اتصال Heleket'],['Affiliate System','نظام الإحالة'],['Commission Percentage (%)','نسبة العمولة (%)'],['Currency Symbol','رمز العملة'],['Support Email','بريد الدعم'],['Site Name','اسم الموقع'],['Site Description (SEO)','وصف الموقع (SEO)'],['Base URL','الرابط الأساسي'],['Public Key','المفتاح العام'],['Secret Key','المفتاح السري'],['Save Settings','حفظ الإعدادات'],['System Logs','سجلات النظام'],['Level','المستوى'],['Message','الرسالة'],['Details','التفاصيل'],['Time','الوقت'],['Filter by level','تصفية حسب المستوى'],['All levels','كل المستويات'],['Loading logs...','جاري تحميل السجلات...'],
...
export function ThemeToggle({ className = '' }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={`inline-flex items-center justify-center w-10 h-10 rounded-xl border-gray-300 border-outline-variant bg-surface-container-high text-on-surface-variant text-on-surface hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-200 shadow-sm ${className}`}
