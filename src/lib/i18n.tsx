...
export const translations: Dict = {
  ...
  'common.bulkActions': { en: 'Bulk Actions', ar: 'إجراءات جماعية' },
  'common.apply': { en: 'Apply', ar: 'تطبيق' },
  'common.exportSuccess': { en: 'Data exported successfully', ar: 'تم تصدير البيانات بنجاح' },
  'common.bulkUpdated': { en: 'Orders updated successfully', ar: 'تم تحديث الطلبات بنجاح' },
  ...
  'admin.dashboard.loading': { en: 'Loading dashboard...', ar: 'جاري تحميل لوحة التحكم...' },
  'admin.dashboard.error': { en: 'Unable to load dashboard data.', ar: 'تعذر تحميل بيانات لوحة التحكم.' },
  'admin.dashboard.retry': { en: 'Retry', ar: 'إعادة المحاولة' },
  'admin.dashboard.subtitle': { en: 'Monitor users, orders, wallet activity and operations.', ar: 'راقب المستخدمين، الطلبات، نشاط المحفظة والعمليات.' },
  'admin.dashboard.days7': { en: '7 days', ar: '7 أيام' },
  'admin.dashboard.days30': { en: '30 days', ar: '30 يوماً' },
  'admin.dashboard.refresh': { en: 'Refresh', ar: 'تحديث' },
  'admin.dashboard.totalUsers': { en: 'Total Users', ar: 'إجمالي المستخدمين' },
  'admin.dashboard.active': { en: 'Active', ar: 'نشط' },
  'admin.dashboard.activeUsers': { en: 'Active Users', ar: 'المستخدمون النشطون' },
  'admin.dashboard.totalOrders': { en: 'Total Orders', ar: 'إجمالي الطلبات' },
  'admin.dashboard.totalRevenue': { en: 'Total Revenue', ar: 'إجمالي الإيرادات' },
  'admin.dashboard.increase': { en: 'Up from yesterday', ar: 'أعلى مقارنة بالأمس' },
  'admin.dashboard.decrease': { en: 'Down from yesterday', ar: 'أسفل مقارنة بالأمس' },
  'admin.dashboard.pendingOrders': { en: 'Pending orders', ar: 'طلبات معلقة' },
  'admin.dashboard.pendingPayments': { en: 'Pending payments', ar: 'مدفوعات معلقة' },
  'admin.dashboard.openTickets': { en: 'Open tickets', ar: 'تذاكر مفتوحة' },
  'admin.dashboard.activeServices': { en: 'Active services', ar: 'خدمات نشطة' },
  'admin.dashboard.ordersByStatus': { en: 'Orders by Status', ar: 'الطلبات حسب الحالة' },
  'admin.dashboard.topServices': { en: 'Top Services', ar: 'أفضل الخدمات' },
  'admin.dashboard.today': { en: 'Today', ar: 'اليوم' },
  'admin.dashboard.platformStatus': { en: 'Platform Status', ar: 'حالة المنصة' },
  'admin.dashboard.activeProviders': { en: 'Active providers', ar: 'مزودو الخدمة النشطون' },
  'admin.dashboard.successfulPayments': { en: 'Successful payments', ar: 'مدفوعات ناجحة' },
  'admin.dashboard.quickManagement': { en: 'Quick Management', ar: 'إدارة سريعة' },
  'admin.dashboard.providers': { en: 'Providers', ar: 'مزودو الخدمة' },
  'admin.dashboard.reports': { en: 'Reports', ar: 'التقارير' },
  'admin.dashboard.orders': { en: 'Orders', ar: 'الطلبات' },
  'admin.dashboard.users': { en: 'Users', ar: 'المستخدمون' },
  'admin.dashboard.analytics': { en: 'Analytics Overview', ar: 'نظرة التحليلات' },
  'admin.dashboard.ordersChart': { en: 'Orders (Last 30 Days)', ar: 'الطلبات (آخر 30 يوماً)' },
  'admin.dashboard.revenueChart': { en: 'Revenue (Last 30 Days)', ar: 'الإيرادات (آخر 30 يوماً)' },
  'admin.dashboard.period': { en: 'Period', ar: 'الفترة' },
  'admin.dashboard.days': { en: 'Days', ar: 'الأيام' },
  'admin.dashboard.trend': { en: 'Trend', ar: 'الاتجاه' },
  'admin.dashboard.up': { en: 'Up', ar: 'أعلى' },
  'admin.dashboard.down': { en: 'Down', ar: 'أسفل' },
  'admin.dashboard.noChange': { en: 'No change', ar: 'بدون تغيير' },
  'admin.dashboard.sales': { en: 'Sales', ar: 'المبيعات' },
  'admin.dashboard.conversion': { en: 'Conversion Rate', ar: 'معدل التحويل' },
  'admin.dashboard.ordersToday': { en: 'Orders Today', ar: 'طلبات اليوم' },
  'admin.dashboard.revenueToday': { en: 'Revenue Today', ar: 'إيرادات اليوم' },
  'admin.dashboard.pending': { en: 'Pending', ar: 'معلق' },
  'admin.dashboard.processing': { en: 'Processing', ar: 'قيد المعالجة' },
  'admin.dashboard.completed': { en: 'Completed', ar: 'مكتمل' },
  'admin.dashboard.cancelled': { en: 'Cancelled', ar: 'ملغي' },
  'admin.dashboard.users.active': { en: 'Active', ar: 'نشط' },
  'admin.dashboard.users.total': { en: 'Total Users', ar: 'مجموع المستخدمين' },
  'admin.dashboard.users.new': { en: 'New Users', ar: 'مستخدمون جدد' },
  'admin.dashboard.export': { en: 'Export Data', ar: 'تصدير البيانات' },
  'admin.dashboard.exportCsv': { en: 'Export CSV', ar: 'تصدير CSV' },
  'admin.dashboard.exportPdf': { en: 'Export PDF', ar: 'تصدير PDF' },
  'admin.dashboard.exportLoading': { en: 'Exporting...', ar: 'جاري التصدير...' },
  'admin.dashboard.exportError': { en: 'Export failed', ar: 'فشل التصدير' },
  'admin.dashboard.exportSuccess': { en: 'Export completed', ar: 'تم التصدير بنجاح' },
  'admin.dashboard.bulkActions': { en: 'Bulk Actions', ar: 'إجراءات جماعية' },
  'admin.dashboard.bulkSelectAll': { en: 'Select all', ar: 'تحديد الكل' },
  'admin.dashboard.bulkDelete': { en: 'Delete selected', ar: 'حذف المحدد' },
  'admin.dashboard.bulkStatusUpdate': { en: 'Update status', ar: 'تحديث الحالة' },
  'admin.dashboard.search': { en: 'Search', ar: 'بحث' },
  'admin.dashboard.searchPlaceholder': { en: 'Search by name, email, or ID', ar: 'ابحث بالاسم، البريد، أو المعرف' },
  'admin.dashboard.filter': { en: 'Filter', ar: 'تصفية' },
  'admin.dashboard.clearFilters': { en: 'Clear filters', ar: 'مسح الفلاتر' },
  'admin.dashboard.actions': { en: 'Actions', ar: 'الإجراءات' },
  'admin.dashboard.view': { en: 'View', ar: 'عرض' },
  'admin.dashboard.edit': { en: 'Edit', ar: 'تعديل' },
  'admin.dashboard.delete': { en: 'Delete', ar: 'حذف' },
  'admin.dashboard.confirm': { en: 'Confirm', ar: 'تأكيد' },
  'admin.dashboard.cancel': { en: 'Cancel', ar: 'إلغاء' },
  'admin.dashboard.save': { en: 'Save', ar: 'حفظ' },
  'admin.users.active': { en: 'Active', ar: 'نشط' },
  'admin.users.suspended': { en: 'Suspended', ar: 'موقوف' },
  'admin.users.banned': { en: 'Banned', ar: 'محظور' },
  'admin.users.headers.email': { en: 'Email', ar: 'البريد الإلكتروني' },
  'admin.users.headers.name': { en: 'Name', ar: 'الاسم' },
  'admin.users.headers.role': { en: 'Role', ar: 'الدور' },
  'admin.users.headers.balance': { en: 'Balance', ar: 'الرصيد' },
  'admin.users.headers.status': { en: 'Status', ar: 'الحالة' },
  'admin.users.headers.actions': { en: 'Actions', ar: 'الإجراءات' },
  'admin.users.loadError': { en: 'Could not load users', ar: 'تعذر تحميل المستخدمين' },
  'admin.users.exportUsers': { en: 'Export Users', ar: 'تصدير المستخدمين' },
  'admin.users.exportSuccess': { en: 'Users exported', ar: 'تم تصدير المستخدمين' },
  'admin.users.bulkStatus': { en: 'Bulk Status Change', ar: 'تغيير الحالة الجماعي' },
  'admin.users.selectStatus': { en: 'Select new status', ar: 'اختر الحالة الجديدة' },
  'admin.users.appliedTo': { en: 'Applied to: {count}', ar: 'تطبيق على: {count}' },
  'admin.users.viewDetails': { en: 'View Details', ar: 'عرض التفاصيل' },
  'admin.users.activate': { en: 'Activate', ar: 'تفعيل' },
  'admin.users.suspend': { en: 'Suspend', ar: 'تعليق' },
  'admin.users.editBalance': { en: 'Edit Balance', ar: 'تعديل الرصيد' },
  'admin.users.editBalanceFor': { en: 'Edit Balance for {name}', ar: 'تعديل الرصيد لـ {name}' },
  'admin.users.balanceAmount': { en: 'Amount to Add / Subtract', ar: 'المبلغ للإضافة / الخصم' },
  'admin.users.balanceHint': { en: 'Use positive numbers to add balance, negative numbers to subtract.', ar: 'استخدم أرقام موجبة لإضافة رصيد، وأرقام سالبة لخصم.' },
  'admin.users.saveBalance': { en: 'Update Balance', ar: 'تحديث الرصيد' },
  'admin.users.balanceUpdated': { en: 'Balance updated successfully', ar: 'تم تحديث الرصيد بنجاح' },
  'admin.users.statusUpdated': { en: 'User status updated', ar: 'تم تحديث حالة المستخدم' },
  'admin.users.noUsers': { en: 'No users found.', ar: 'لا يوجد مستخدمون.' },
  'admin.users.role': { en: 'Role', ar: 'الدور' },
  'admin.users.balance': { en: 'Balance', ar: 'الرصيد' },
  'admin.orders.exportOrders': { en: 'Export Orders', ar: 'تصدير الطلبات' },
  'admin.orders.bulkStatus': { en: 'Bulk Status Change', ar: 'تغيير الحالة الجماعي' },
  'admin.orders.selectStatus': { en: 'Select new status', ar: 'اختر الحالة الجديدة' },
  'admin.orders.bulkRefund': { en: 'Bulk Refund', ar: 'إرجاع الأموال الجماعي' },
  'admin.orders.title': { en: 'Order Control Center', ar: 'مركز التحكم في الطلبات' },
  'admin.orders.subtitle': { en: 'Search, filter, refresh provider status, export orders, and perform bulk actions.', ar: 'ابحث، فلّتر، حدّث حالة المزود، صدّر الطلبات، ونفّذ إجراءات جماعية.' },
  'admin.orders.searchPlaceholder': { en: 'Search order ID, service, or provider ID...', ar: 'ابحث برقم الطلب، الخدمة، أو معرف المزود...' },
  'admin.orders.refreshSuccess': { en: 'Order status refreshed', ar: 'تم تحديث حالة الطلب' },
  'admin.orders.manual': { en: 'Manual', ar: 'يدوي' },
  'admin.orders.provider': { en: 'Provider', ar: 'مزود خدمة' },
  'admin.orders.cancel': { en: 'Cancel', ar: 'إلغاء' },
  'admin.orders.cancelConfirm': { en: 'Are you sure you want to cancel this order?', ar: 'هل أنت متأكد من إلغاء هذا الطلب؟' },
  'admin.orders.cancelRequested': { en: 'Cancellation requested', ar: 'تم طلب الإلغاء' },
  'admin.orders.headers.id': { en: 'ID', ar: 'المعرّف' },
  'admin.orders.headers.user': { en: 'User', ar: 'المستخدم' },
  'admin.orders.headers.service': { en: 'Service', ar: 'الخدمة' },
  'admin.orders.headers.mode': { en: 'Mode', ar: 'طريقة التنفيذ' },
  'admin.orders.headers.qty': { en: 'Qty', ar: 'الكمية' },
  'admin.orders.headers.start': { en: 'Start', ar: 'البداية' },
  'admin.orders.headers.remains': { en: 'Remains', ar: 'المتبقي' },
  'admin.orders.headers.charge': { en: 'Charge', ar: 'التكلفة' },
  'admin.orders.headers.status': { en: 'Status', ar: 'الحالة' },
  'admin.orders.headers.provider_id': { en: 'Provider ID', ar: 'معرف المزود' },
  'admin.orders.headers.actions': { en: 'Actions', ar: 'الإجراءات' },
  ...
  'landing.heroSubtitle': { en: 'Pick a service, paste a link, and watch it move. {site} connects you to a reliable service network with automated dispatch, real-time tracking, and payment methods built for Egypt.', ar: 'اختر الخدمة، الصق الرابط، وشاهد التنفيذ يبدأ. {site} يربطك بمنظومة تنفيذ موثوقة مع تنفيذ تلقائي، متابعة لحظية، ووسائل دفع مناسبة للسوق المصري.' },
  ...
  'landing.feature1Body': { en: 'Place an order and it goes straight to the service system — no manual approval queue holding up your delivery.', ar: 'اطلب وسيتم إرسال طلبك مباشرة لمنظومة التنفيذ — بدون طابور موافقات يدوي يؤخر التنفيذ.' },
  ...
  'landing.feature4Body': { en: "Open a ticket from your dashboard any time. Our support team follows up on your request.", ar: 'افتح تذكرة دعم من لوحة التحكم في أي وقت. فريق الدعم بيتابع طلبك ويساعدك في حله.' },
  ...
  'landing.security3Title': { en: 'Secure account authentication', ar: 'تسجيل دخول آمن' },
  ...
  'landing.faq2A': { en: 'Most orders start within minutes of payment clearing — dispatch to the service system is automatic, not manually queued. Larger orders run gradually and you can watch the remaining count drop from your dashboard.', ar: 'معظم الطلبات تبدأ خلال دقائق من تأكيد الدفع — الإرسال لمنظومة التنفيذ تلقائي مش طابور يدوي. الطلبات الكبيرة تتنفذ تدريجياً وتقدر تتابع العدد المتبقي من لوحة التحكم.' },
  ...
  'landing.faq5A': { en: 'Electronic-wallet payments are verified by the gateway, not stored as wallet credentials on our servers. Your dashboard is protected by Secure account authentication, and every wallet transaction is written to an append-only ledger so your balance history can always be reconciled.', ar: 'مدفوعات المحافظ الإلكترونية يتم التحقق منها عبر بوابة الدفع ولا يتم تخزين الرقم السري للمحفظة. لوحة التحكم تستخدم حماية آمنة للحساب، وكل معاملة في محفظتك تُسجل في سجل دائم قابل للمراجعة.' },
  ...
  'newOrder.orderFailed': { en: 'We could not create the order. Your balance was not charged.', ar: 'تعذر إنشاء الطلب. لم يتم خصم أي مبلغ من رصيدك.' },
  ...
  'addFunds.crypto': { en: 'Cryptocurrency', ar: 'العملات الرقمية' },
  ...
  'addFunds.paymentPending': { en: 'Payment request is awaiting confirmation', ar: 'طلب الدفع في انتظار التأكيد' },
  'addFunds.paymentCreated': { en: 'Payment request created. Confirm it from your wallet.', ar: 'تم إنشاء طلب الدفع. أكّد العملية من محفظتك.' },
  'addFunds.paymentConfirmed': { en: 'Payment confirmed and your balance has been credited.', ar: 'تم تأكيد الدفع وإضافة الرصيد.' },
  'addFunds.paymentStillPending': { en: 'The payment is still pending. Please check again shortly.', ar: 'العملية ما زالت معلقة. جرّب التحقق مرة أخرى بعد قليل.' },
  'addFunds.invoiceCreated': { en: 'Crypto payment invoice created.', ar: 'تم إنشاء فاتورة الدفع بالعملات الرقمية.' },
  'addFunds.verifying': { en: 'Verifying...', ar: 'جاري التحقق...' },
  'addFunds.confirmPayment': { en: 'Confirm payment and verify', ar: 'تأكيد الدفع والتحقق من العملية' },
  'addFunds.walletUnavailable': { en: 'Electronic wallets are currently unavailable.', ar: 'المحافظ الإلكترونية غير متاحة حالياً.' },
  'addFunds.approxCredit': { en: 'Estimated wallet credit:', ar: 'الرصيد المتوقع إضافته:' },
  'addFunds.creatingInvoice': { en: 'Creating invoice...', ar: 'جاري إنشاء الفاتورة...' },
  'addFunds.createInvoice': { en: 'Create payment invoice', ar: 'إنشاء فاتورة دفع' },
  'addFunds.cryptoUnavailable': { en: 'Crypto payments are currently unavailable.', ar: 'الدفع بالعملات الرقمية غير متاح حالياً.' },
  'addFunds.reference': { en: 'Reference', ar: 'رقم المرجع' },
  ...
  'api.docTitle': { en: 'SMM API v2 Documentation', ar: 'توثيق واجهة برمجة التطبيقات SMM v2' },
  'api.docSubtitle': { en: 'Standard SMM Panel API for resellers and integrators.', ar: 'واجهة برمجة تطبيقات SMM قياسية للموزعين والمطورين.' },
  'api.docIntro': { en: 'Send requests to the endpoint below with your API key and the desired action.', ar: 'أرسل الطلبات إلى النقطة التالية باستخدام مفتاح_API الخاص بك والإجراء المطلوب.' },
  'api.docKey': { en: 'API Key', ar: 'مفتاح API' },
  'api.docKeyDesc': { en: 'Your secret API key. Never share it.', ar: 'مفتاح API السرى الخاص بك. لا تشاركه أبدًا.' },
  'api.docActions': { en: 'Available Actions', ar: 'الإجراءات المتاحة' },
  'api.docServices': { en: 'Services', ar: 'الخدمات' },
  'api.docServicesDesc': { en: 'Returns all active services available on the platform.', ar: 'يعيد جميع الخدمات النشطة المتاحة على المنصة.' },
  'api.docAdd': { en: 'Add Order', ar: 'إنشاء طلب' },
  'api.docAddDesc': { en: 'Creates a new order. Deducts balance and returns the order ID.', ar: 'ينشئ طلبًا جديدًا. يخصم من الرصيد ويعيد معرف الطلب.' },
  'api.docStatus': { en: 'Order Status', ar: 'حالة الطلب' },
  'api.docStatusDesc': { en: 'Returns the status of one or more orders.', ar: 'يعيد حالة طلب أو عدة طلبات.' },
  'api.docBalance': { en: 'Balance', ar: 'الرصيد' },
  'api.docBalanceDesc': { en: 'Returns your account balance and currency.', ar: 'يعيد رصيد حسابك والعملة.' },
  'api.paramKey': { en: 'key', ar: 'المفتاح' },
  'api.paramAction': { en: 'action', ar: 'الإجراء' },
  'api.paramService': { en: 'service', ar: 'الخدمة' },
  'api.paramLink': { en: 'link', ar: 'الرابط' },
  'api.paramQuantity': { en: 'quantity', ar: 'الكمية' },
  'api.paramOrder': { en: 'order', ar: 'معرف الطلب' },
  'api.paramOrders': { en: 'orders', ar: 'معرفات الطلبات' },
  'api.paramRequired': { en: 'Required', ar: 'مطلوب' },
  'api.paramOptional': { en: 'Optional', ar: 'اختياري' },
...
const uiPhrasePairs: Array<[string, string]> = [
  ...
  ['Choose your service','اختر الخدمة'],['Select category','اختر القسم'],['Service information','معلومات الخدمة'],['Quantity','الكمية'],['Valid quantity','الكمية الصحيحة'],['Cashback','كاش باك'],['Refill','إعادة تعبئة'],['Cancel','إلغاء'],['Loading...','جاري التحميل...'],['Refresh','تحديث'],['Actions','الإجراءات'],['Status','الحالة'],['Active','نشط'],['Inactive','غير نشط'],['Edit','تعديل'],['Delete','حذف'],['Save','حفظ'],['Create','إنشاء'],['Close','إغلاق'],['Open','فتح'],['Search','بحث'],['Name','الاسم'],['Email','البريد الإلكتروني'],['Password','كلمة المرور'],['Balance','الرصيد'],['Amount','المبلغ'],['Date','التاريخ'],['Type','النوع'],['Service','الخدمة'],['Category','القسم'],['Orders','الطلبات'],['User','المستخدم'],['Method','الطريقة'],['Price','السعر'],['Prize','الجائزة'],['Tickets','التذاكر'],['Title','العنوان'],['Role','الدور'],['Quantity','الكمية'],
  ...
  ['Check balance','عرض الرصيد'],['Unavailable — retry','غير متاح — إعادة المحاولة'],['Testing','جارٍ الاختبار'],['Test','اختبار'],['Syncing…','جارٍ المزامنة…'],['Sync','مزامنة'],['Synchronizing provider services…','جارٍ مزامنة خدمات المزود…'],['Processed','تمت معالجة'],['Clear','مسح'],['Select all','تحديد الكل'],['Export CSV','تصدير CSV'],['Export All','تصدير الكل'],['Export This Page','تصدير الصفحة'],['Select','اختيار'],['Apply','تطبيق'],['Bulk Status Change','تغيير الحالة الجماعي'],['Applied to','تطبيق على'],['Data exported successfully','تم تصدير البيانات بنجاح'],['Orders updated successfully','تم تحديث الطلبات بنجاح'],['Export Users','تصدير المستخدمين'],['Export Orders','تصدير الطلبات'],['Users exported','تم تصدير المستخدمين'],['Orders exported','تم تصدير الطلبات'],['Select new status','اختر الحالة الجديدة'],['Updating...','جارٍ التحديث...'],['Apply to','تطبيق على'],['We hit a temporary problem','حدثت مشكلة مؤقتة'],['The page could not finish this action. Your account and data are safe. Please try again.','تعذر إكمال العملية. حسابك وبياناتك بأمان. حاول مرة أخرى.'],['Mark as replied','تحديد كمُجاب عليه'],['Reply by email','الرد عبر البريد الإلكتروني'],['Resolve','حل المشكلة'],['Reopen Ticket','إعادة فتح التذكرة'],['Close Ticket','إغلاق التذكرة'],['Ticket not found','التذكرة غير موجودة'],
];
...
export function ThemeToggle({ className = '' }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={`inline-flex items-center justify-center w-10 h-10 rounded-xl border border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-200 shadow-sm ${className}`}
