...
const SECTIONS_EN = [
  ...
  { h: '4. Third-party services', b: 'We rely on a small number of third-party services to operate: Firebase (authentication), the electronic-wallet payment gateway, and our order-fulfillment provider network (to deliver the services you order). Each of these providers processes only the data necessary to perform its function.' },
...
const SECTIONS_AR = [
  ...
  { h: '٤. خدمات الطرف الثالث', b: 'نعتمد على عدد قليل من الخدمات الخارجية للتشغيل: Firebase (التوثيق)، بوابة دفع المحافظ الإلكترونية، وشبكة مزودي التنفيذ (لتنفيذ الخدمات التي تطلبها). كل من هذه الخدمات يعالج فقط البيانات اللازمة لأداء وظيفته.' },
