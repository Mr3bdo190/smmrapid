...
export default function PublicSupport(){
 ...
 return <PublicPageShell title="Customer Support">
   ...
   <div className="rapid-public-cards">
    {email ? <a href={`mailto:${email}`} className="rapid-public-card"><span className="rapid-public-icon"><Mail/></span><h2>Email support</h2><p>{email}</p><strong>Contact support <ArrowRight/></strong></a> : <div className="rapid-public-card"><span className="rapid-public-icon"><Mail/></span><h2>Email support</h2><p>Use the support form below or open a support ticket from your account.</p><strong>Support is available from your dashboard</strong></div>}
