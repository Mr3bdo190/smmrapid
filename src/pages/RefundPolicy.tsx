...
const SECTIONS_EN = [
  ...
  { h: '6. Wallet balance vs. cash refunds', b: 'Refunds are issued as wallet balance by default, which can be used for future orders immediately. If you paid through the electronic-wallet gateway and need a payment reversal, contact support with your transaction reference; processing time depends on the gateway.' },
...
const SECTIONS_AR = [
  ...
  { h: '٦. رصيد المحفظة مقابل الاسترجاع النقدي', b: 'يتم إصدار الاسترجاع كرصيد بالمحفظة افتراضياً، ويمكن استخدامه فوراً لطلبات مستقبلية. إذا دفعت عبر بوابة المحفظة الإلكترونية وتحتاج عكس العملية، تواصل مع الدعم مع رقم العملية؛ مدة المعالجة تعتمد على البوابة.' },
