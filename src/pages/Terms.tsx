...
const SECTIONS_EN = [
  ...
  { h: '3. How orders work', b: 'You add funds to your account wallet, then place an order for a specific service by providing a link and a quantity. Orders are processed automatically once payment clears. Delivery times vary by service and are estimates, not guarantees.' },
  ...
  { h: '6. Payments', b: 'We accept Vodafone Cash, electronic-wallet payments verified through the payment gateway, and cryptocurrency. Wallet balances are recorded in an internal ledger and are non-transferable between accounts.' },
...
const SECTIONS_AR = [
  ...
  { h: '٦. الدفع', b: 'نقبل فودافون كاش، والدفع عبر المحفظة الإلكترونية، والعملات الرقمية. أرصدة المحفظة مسجلة في سجل داخلي وغير قابلة للتحويل بين الحسابات.' },
