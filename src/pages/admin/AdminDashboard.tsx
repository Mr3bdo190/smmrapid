...
function SmallStat({ title, value, href }: { title: string; value: any; href: string }) {
  return (
    <Link to={href} className="bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 p-4 hover:border-indigo-200 dark:hover:border-indigo-500 transition-colors">
