  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="flex justify-between items-center">
        <h3 className="text-xl font-bold text-gray-900 dark:text-white tracking-tight">{t('nav.admin.settings')}</h3>
      ...
      {/* Tab Navigation */}
      <div className="border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 rounded-t-xl shadow-sm">
      ...
      {/* Tab Content */}
      <div className="bg-white dark:bg-gray-800 rounded-b-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 min-h-[400px]">
        ...
        {activeTab === 'general' && (
          <div className="space-y-6" dir="ltr">
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 pt-6" dir="ltr">
              <h5 className="text-sm font-bold text-gray-900 dark:text-white mb-4">{t('admin.settings.affiliate')}</h5>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
        ...
        {activeTab === 'financial' && (
          <div className="space-y-6" dir="ltr">
            <h4 className="text-lg font-semibold text-gray-900 dark:text-white">{t('admin.settings.financial')}</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
              <h5 className="text-sm font-bold text-gray-900 dark:text-white mb-4">{t('admin.settings.exchange')}</h5>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
        ...
        {activeTab === 'api' && (
          <div className="space-y-6" dir="ltr">
            ...
            <div className="rounded-xl bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 p-5 space-y-4">
              <div>
        ...
        {activeTab === 'payments' && (
          <div className="space-y-6" dir="ltr">
            ...
            <div className="rounded-xl border border-indigo-100 dark:border-indigo-900 bg-indigo-50 dark:bg-indigo-900/20 p-5 space-y-4">
              ...
              <div className="rounded-xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 p-4 text-xs text-gray-600 dark:text-gray-400 space-y-2">
                <p><strong>{t('admin.settings.webhook')}:</strong> <code className="bg-gray-100 dark:bg-gray-700 px-1 rounded">/api/shahnawy/webhook</code> — {t('admin.settings.webhookDesc')}</p>
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
              <h5 className="text-sm font-bold text-gray-900 dark:text-white mb-2">{t('admin.settings.addFundsInstructions')}</h5>
