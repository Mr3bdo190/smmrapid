...
export default function ClientApi() {
  ...
  return (
    <div className="space-y-6 max-w-4xl dark:text-gray-200">
      <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 flex items-center gap-2"><Code className="text-indigo-600 dark:text-indigo-400"/> {t('api.title')}</h2>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-100 dark:border-slate-700 p-6 space-y-4">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">{t('api.usageDesc')}</p>

        <div className="mt-4">
          <h4 className="font-semibold text-gray-900 dark:text-gray-100 dark:text-gray-200">{t('api.httpMethod')}</h4>
          <code className="text-sm bg-gray-50 dark:bg-slate-700 dark:text-gray-300 px-2 py-1 rounded">POST</code>
        </div>
        <div className="mt-4">
          <h4 className="font-semibold text-gray-900 dark:text-gray-100 dark:text-gray-200">{t('api.apiUrl')}</h4>
        ...
        <div className="mt-6 border-t pt-4">
          <h4 className="font-semibold text-lg text-gray-900 dark:text-gray-100 dark:text-gray-200 mb-2">{t('api.placeOrderExample')}</h4>
