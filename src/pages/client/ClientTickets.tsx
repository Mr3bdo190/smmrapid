  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 flex items-center gap-2"><LifeBuoy className="text-indigo-600"/> {t('nav.tickets')}</h2>
          ...
          <tbody className="bg-white divide-y divide-gray-100">
            {tickets.map((tk: any) => (
              <tr key={tk.id} className="hover:bg-gray-50 dark:hover:bg-slate-700/50">
                <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-gray-100 dark:text-gray-100">{tk.subject}</td>
